...
SPARQL查询语句是以[Turtle](http://www.w3.org/TeamSubmission/turtle/)语法为基础的，比XML更流畅，并且基于模式匹配机制。SPARQL查询语句的基本片段类似于RDF三元组（主体，谓词，客体），如以下示例所示，其中变量出现在主体和客体的位置，dbpedia-owl是http://dbpedia.org/ontology/ 的前缀。
